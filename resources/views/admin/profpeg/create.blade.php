    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.profil-pegawai.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 text-left">
                            ...
                            <a class="btn btn-light" href="{{ route('admin.profil-pegawai.index') }}">Batal</a>
                        </div>
