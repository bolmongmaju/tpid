    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.profil-pegawai.index') }}" method="GET">
                        <div class="form-group">
                            <div class="input-group mb-3">
                                @can('downloads.create')
                                <div class="input-group-prepend">
                                    <a href="{{ route('admin.profil-pegawai.create') }}" class="btn btn-primary"
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @can('profpegs.edit')
                                            <a href="{{ route('admin.profil-pegawai.edit', $item->id) }}" class="btn btn-sm btn-primary">
    ...
    function Delete(id)
        {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    //ajax delete
                    jQuery.ajax({
                        url: "{{ route("admin.profil-pegawai.index") }}/"+id,
                        data:     {
                            "id": id,
                            "_token": token
                        },
