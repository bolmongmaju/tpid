...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            @can('infografis.create')
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-laptop"></i> Upload Infografis</h4>
                    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-laptop"></i> Infografis</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            @forelse ($infografis as $no => $item)
                                <tr>
                                    <th scope="row" style="text-align: center">{{ ++$no + ($infografis->currentPage()-1) * $infografis->perPage() }}</th>
                                    <td><img src="{{ $item->image }}" style="width: 200px"></td>
                                    <td>{{ $item->title }}</td>
                                    <td class="text-center">
                                        @can('infografis.delete')
                        ...
                        <div style="text-align: center">
                            {{$infografis->links("vendor.pagination.bootstrap-4")}}
                        </div>
                    </div>
                </div>
            </div>
    ...
    function Delete(id)
        {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    //ajax delete
                    jQuery.ajax({
                        url: "{{ route("admin.infografis.index") }}/"+id,
                        data:     {
                            "id": id,
                            "_token": token
                        },
