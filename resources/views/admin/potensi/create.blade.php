            ...
            <div class="section-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-bell"></i> Tambah Potensi</h4>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.potensi.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>BODY</label>
                                <textarea class="form-control content @error('body') is-invalid @enderror" name="body" placeholder="Masukkan Body" rows="10">{!! old('body') !!}</textarea>
                                @error('body')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
                                </div>
